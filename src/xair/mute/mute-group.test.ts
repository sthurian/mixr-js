...
suite('MuteGroup', () => {
  ...
  test('send the correct osc message to check if something is assigned to MUTE1', async () => {
  ...
  test('send the correct osc message to check if something is assigned to MUTE2', async () => {
    const query = fake.resolves({
      address: '/ch/01/grp/mute',
  ...
  test('send the correct osc message to check if something is assigned to MUTE3', async () => {
    const query = fake.resolves({
      address: '/ch/01/grp/mute',
  ...
  test('send the correct osc message to check if something is assigned to MUTE4', async () => {
    const query = fake.resolves({
      address: '/ch/01/grp/mute',
      args: [{ type: 'integer', value: MUTE1 | MUTE3 }],
    });
